...
if __name__ == '__main__':
    ...
    parser.add_argument('-noise_type', '-nt', type=str, default='thr_variation_1_10')
    parser.add_argument('-detection_model', '-dm', type=str, default='dbscan')
    parser.add_argument('-algorithm_hyper', '-ah', type=float, default=1.2)
    ...
    if detection_model == 'if':
        ...
        dbscan = DBSCAN(eps=algorithm_hyper,
